...
$(document).ready(function() {
	...
	if (typeof editorInsertThumbnail != "function") {
		window.editorInsertThumbnail = function(thumbnail, image){
			$("#jseditor").val($('#jseditor').val()+'<a href="'+image+'"><img src="'+thumbnail+'" alt=""></a>');
		};
	}
